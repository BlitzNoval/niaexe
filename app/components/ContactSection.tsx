		...
		<section className="px-6 md:px-12 lg:px-24 py-32">
			<div className="max-w-7xl mx-auto">
				...
				<div className="max-w-4xl mx-auto">
					<div className="bg-gray-50 rounded-2xl p-12 text-center space-y-12">
						<div className="space-y-8">
							<a 
								href="mailto:niaexedev@gmail.com"
								className="inline-flex items-center gap-4 text-black hover:text-gray-600 transition-colors text-xl font-medium bg-white px-8 py-4 rounded-full shadow-sm hover:shadow-md"
							>
						...
						<div className="flex justify-center gap-6">
							<a 
								...
								className="text-gray-600 hover:text-black transition-colors p-4 hover:bg-white rounded-full"
								aria-label="GitHub"
							>
