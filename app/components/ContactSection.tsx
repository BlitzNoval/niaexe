					...
					<div className="space-y-12">
						<div className="space-y-6">
							<a 
								...
								className="inline-flex items-center gap-3 text-black hover:text-gray-600 transition-colors body-lg"
							>
							...
							<div className="flex items-center gap-3 text-black body-md">
