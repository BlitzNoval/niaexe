		...
		<ParallaxWrapper speed={0.3}>
			...
			<div className="max-w-3xl mx-auto text-center">
				...
				>
					...
					<a href="https://www.figma.com/@liammoodley" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
